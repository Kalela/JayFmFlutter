        ...
        return DefaultTabController(
          ...
          child: SharedScaffold(
            ...
            appBar: AppBar(
              ...
              iconTheme: IconThemeData(color: state.colors.textTheme!.bodyLarge!.color),
              // textTheme: state.colors.textTheme,
              bottom: PreferredSize(
                preferredSize: Size.fromHeight(30.0),
                child: TabBar(
                  tabs: [
                    topBarTab("Live", state.colors.textTheme!.titleLarge!.color),
                    topBarTab("Browse", state.colors.textTheme!.titleLarge!.color),
                    topBarTab("Saved", state.colors.textTheme!.titleLarge!.color),
                  ],
                ),
              ),
            ),
